...
----------------------------------------------
Once the market receives its Initial Report it enters the Waiting for the Next Fee Window to Begin Phase (state c in the figure above). During this phase, Reporting for the Market is on hold until end of the current [Dispute Window](#dispute-window). Once the next Fee Window begins, the Market enters the [Dispute Round Phase](#dispute-round-phase).
