...
Augur's smart contract ABIs are generated and output to `packages/augur-artifacts/abi.json` in the [augur-core package](https://github.com/AugurProject/augur/tree/master/packages/augur-core) by the script `source/supper/artifacts/run.sh` script. For further details on Augur's smart contracts and their compiling/deployment process, please refer to the README file in the [augur-core package](https://github.com/AugurProject/augur/tree/master/packages/augur-core).
