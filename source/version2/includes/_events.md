...
<a name="Transfer"></a>Transfer | [ERC20Basic](https://github.com/AugurProject/augur/blob/master/packages/augur-core/source/contracts/libraries/token/ERC20Basic.sol) | Transferred `value` [attotokens](#atto-prefix) between accounts `from` and `to`. | from, to | value
